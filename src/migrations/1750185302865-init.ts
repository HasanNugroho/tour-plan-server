...
export class Init1750185302865 implements MigrationInterface {
    name = 'Init1750185302865'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."files_file_type_enum" AS ENUM('cv', 'photo', 'document', 'image', 'other')
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."files_upload_status_enum" AS ENUM('pending', 'completed', 'failed')
        `);
        await queryRunner.query(`
            CREATE TABLE "files" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                ...
                "file_type" "public"."files_file_type_enum" NOT NULL DEFAULT 'other',
                "tenantId" uuid,
                "upload_status" "public"."files_upload_status_enum" NOT NULL DEFAULT 'pending',
        ...
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_269610c73dc40cbf3e07e689b2" ON "files" ("tenantId")
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_85adb0e422634c1c7dd4c0768e" ON "files" ("tenantId", "uploaded_by")
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_0d5b1cf5b6550426f8b2bba0fd" ON "files" ("upload_status", "created_at")
        `);
        await queryRunner.query(`
            ALTER TABLE "users"
        ...
        await queryRunner.query(`
            ALTER TABLE "files"
            ADD CONSTRAINT "FK_269610c73dc40cbf3e07e689b25" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "files"
            ADD CONSTRAINT "FK_63c92c51cd7fd95c2d79d709b61" FOREIGN KEY ("uploaded_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_0d5b1cf5b6550426f8b2bba0fd"
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_85adb0e422634c1c7dd4c0768e"
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_269610c73dc40cbf3e07e689b2"
        `);
        await queryRunner.query(`
            DROP TABLE "files"
        `);
        await queryRunner.query(`
            DROP TYPE "public"."files_upload_status_enum"
        `);
        await queryRunner.query(`
            DROP TYPE "public"."files_file_type_enum"
        `);
        await queryRunner.query(`
