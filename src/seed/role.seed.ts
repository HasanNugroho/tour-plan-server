...
const rolesData = [
  {
    ...
    permissions: [
      ...
      "roles:create", "roles:read", "roles:update", "roles:delete", "roles:assign", "roles:unassign",
      "tenants:create", "tenants:read", "tenants:update", "tenants:delete", "tenants:activate", "tenants:deactivate",
      "system:manage_settings", "system:view_logs", "system:send_announcement",
      "subscription:view", "subscription:change_plan",
      "dashboard:view", "dashboard:view_notifications"
    ]
  },
  {
    name: "admin_tenant",
    ...
    permissions: [
      ...
      "rundowns:create", "rundowns:read", "rundowns:update", "rundowns:delete", "rundowns:assign_team",
      "budgets:create", "budgets:read", "budgets:update", "budgets:delete",
      "expenses:create", "expenses:read", "expenses:update", "expenses:delete",
      "quotations:create", "quotations:read", "quotations:update", "quotations:delete", "quotations:send_to_client",
      "reports:view_summary", "reports:view_per_tour", "reports:export_pdf",
      "dashboard:view", "dashboard:view_financial_status", "dashboard:view_notifications",
      "subscription:view"
    ]
  },
  {
    ...
    permissions: [
      "tours:create", "tours:read", "tours:update",
      "rundowns:create", "rundowns:read", "rundowns:update", "rundowns:assign_team",
  ...
  },
  {
    ...
    permissions: [
      ...
      "reports:view_summary", "reports:export_pdf",
